...
Login_form, _ = uic.loadUiType("data/login.ui")

Message_form, _ = uic.loadUiType("data/message.ui")

Form, _ = uic.loadUiType("data/client_gui.ui")

Admin_form, _ = uic.loadUiType("data/admin.ui")
